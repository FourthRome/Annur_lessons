# Домашние задания
## Занятие 33 (23.12.2022)
- [ ] Посмотри разбор ([ссылка](https://github.com/FourthRome/Annur_lessons/blob/main/LeetCode/network-delay-time.py)) задачи ([ссылка](https://leetcode.com/problems/network-delay-time/description/)) на алгоритм ([ссылка](https://ru.wikipedia.org/wiki/%D0%90%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC_%D0%94%D0%B5%D0%B9%D0%BA%D1%81%D1%82%D1%80%D1%8B)) Дейкстры ([ссылка](https://ru.wikipedia.org/wiki/%D0%94%D0%B5%D0%B9%D0%BA%D1%81%D1%82%D1%80%D0%B0,_%D0%AD%D0%B4%D1%81%D0%B3%D0%B5%D1%80_%D0%92%D0%B8%D0%B1%D0%B5)), подготовь вопросы (Что осталось непонятным? Есть ли ещё что-то, что может быть полезно узнать про это?)
- [ ] Попробуй решить [ещё одну задачу](https://leetcode.com/problems/find-the-city-with-the-smallest-number-of-neighbors-at-a-threshold-distance/) на поиск кратчайшего пути (пока можно использовать линейный поиск следующей вершины для рассмотрения); не забывай задавать вопросы, когда что-то непонятно!
- [ ] Выбрать сеттинг (нарративный + визуальный стиль) для дерева прокачки, которое я составляю для нашей подготовки (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧ *геймификация!*
## Занятие 32 (19.12.2022)
Решали задачи с регионального этапа Всероса прошлого года (первый день)
## Занятие 31 (17.12.2022)
- [ ] [Задача про восстановление бинарного дерева поиска после единственного свопа](https://leetcode.com/problems/recover-binary-search-tree/)
## Занятие 30 (12.12.2022)
- [ ] Посмотри ещё раз решение ([ссылка](https://github.com/FourthRome/Annur_lessons/blob/main/LeetCode/surrounded-regions.py)) задачи ([ссылка](https://leetcode.com/problems/surrounded-regions/)) про области из нулей (использован BFS); подготовь (запиши) вопросы
...
- [x] [Найти значение логического выражения](https://leetcode.com/problems/evaluate-boolean-binary-tree/)
- [x] [Поиск в двоичном дереве поиска (binary search tree, BST) ](https://leetcode.com/problems/search-in-a-binary-search-tree/)
- [x] [pre-order обход N-арного дерева](https://leetcode.com/problems/n-ary-tree-preorder-traversal/)
- [x] [Максимальная глубина N-арного дерева](https://leetcode.com/problems/maximum-depth-of-n-ary-tree/)
## Занятие 28 (05.12.2022)
- [x] **Задание на ресёрч.** Нужно ответить на вопросы (сначала подумать без привлечения внешних источников, затем наоборот, заиспользовав навыки поиска и анализа информации в Интернете):
  - [x] **Что такое** граф? Чем этот термин отличается от термина "дерево"?
  - [x] **Какие бывают графы?** Не нужен полный набор терминов; только те, которые покажутся тебе важными/чем-то заинтересуют (в список ответов на этот вопрос можно включить сколь угодно сложные термины, но для каждого пункта нужно найти и понять определение)
  - [x] **Что такое BFS и DFS?** Приведи по два примера из твоей жизни, когда ты их используешь (вероятно, неосознанно)
